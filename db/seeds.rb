...
Subscription.delete_all
    ...
    Subscription.create(name: "AuditRisk", description: "Cancel", section_ids: [1,2], amount: 5.00, valid_log: 23, valid_period: 1, user_count: 10, file_size: 40)
    Subscription.create(name: "Audit", description: "Audit", section_ids: [1], amount: 0.00, valid_log: 23, valid_period: 1, user_count: 25, file_size: 60)
